...
<script src="/javascript/bootstrap-filestyle.min.js"></script>
<title>파일 올리기</title>
</head>
<body>
    <br>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="/drive/"><button type="button" class="btn btn-success">Close</button></a>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
	...
	$('#uploadForm').submit(function(e) {
		...
		$.ajax({
			...
			processData: false, 
            contentType: false,
			url : '/drive/upload-normal-file.jsp',
			data : fd,
